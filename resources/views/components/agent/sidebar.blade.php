        ...
        <div class="mb-14">
            <a href="{{ route('agent') }}" class="block">
                <h1 class="font-display text-2xl font-bold text-[#171717] inline-flex items-center">
                    Repeat <span class="font-normal ml-2">Agent</span>
                </h1>
            </a>
        </div>
        <nav class="space-y-3">
            <a href="{{ route('agent') }}"
                class="flex items-center text-[#171717] hover:text-[#171717] font-medium group transition-all duration-200 {{ request()->routeIs('agent') ? 'bg-black/10 -mx-4 px-4 py-3 rounded-lg' : 'py-2' }}">
            ...
            <a href="{{ route('agent.tickets') }}"
                class="flex items-center text-[#171717] hover:text-[#171717] font-medium group transition-all duration-200 {{ request()->routeIs('agent.tickets') ? 'bg-black/10 -mx-4 px-4 py-3 rounded-lg' : 'py-2' }}">
                <div class="w-8 h-8 bg-black/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-black/20 transition-colors duration-200">
            ...
            <a href="{{ route('agent.profile') }}"
                class="flex items-center text-[#171717] hover:text-[#171717] font-medium group transition-all duration-200 {{ request()->routeIs('agent.profile') ? 'bg-black/10 -mx-4 px-4 py-3 rounded-lg' : 'py-2' }}">
                <div class="w-8 h-8 bg-black/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-black/20 transition-colors duration-200">
